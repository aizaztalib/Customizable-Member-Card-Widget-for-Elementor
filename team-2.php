 ...
 * Widget Name: Team 2
 */
class Xhub_Team2 extends Widget_Base{
...
// After the Xhub_Team2 class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new Xhub_Team2() );